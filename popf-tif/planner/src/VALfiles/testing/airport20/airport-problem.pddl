...
(:init
	(needs-to-be-parked airplane_CFBEG)
	(needs-to-be-airborne airplane_DAEWH)
	(needs-to-be-airborne airplane_DFBOY)
	(needs-to-be-airborne airplane_WURST)
	(needs-to-be-airborne airplane_HORST)
	(needs-to-be-parked airplane_HOLGI)
	(needs-to-be-parked airplane_4XEKD)
	(= (fuel-wasted) 0)
      (nothing)
      ...
      (should-be-moving airplane_CFBEG)
      (should-be-moving airplane_HOLGI)
      (should-be-moving airplane_4XEKD)
      ...
      (not-already-moving airplane_WURST)
      ...
      (not-burning-fuel airplane_CFBEG)
      (= (engines airplane_CFBEG) 2)
      (not-burning-fuel airplane_DAEWH)
      (not-already-moving airplane_DAEWH)
      (= (engines airplane_DAEWH) 2)
      (not-burning-fuel airplane_DFBOY)
      (not-already-moving airplane_DFBOY)
      (= (engines airplane_DFBOY) 2)
      (not-burning-fuel airplane_WURST)
      (= (engines airplane_WURST) 2)
      (not-burning-fuel airplane_HORST)
      (not-already-moving airplane_HORST)
      (= (engines airplane_HORST) 2)
      (not-burning-fuel airplane_HOLGI)
      (= (engines airplane_HOLGI) 2)
      (not-burning-fuel airplane_4XEKD)
