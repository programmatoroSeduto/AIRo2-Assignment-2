...
class NumericAnalysis
{
    ...
    protected:
        ...
        class MaskedVariableBounds {
            ...
            public:
                ...
                void tightenUpper(const int & v, const double & u) {
                    if (v == -3) {
                        if (durationBounds.second > v) {
                            durationBounds.second = v;
                        }
                    } else {
                ...
                void tightenLower(const int & v, const double & u) {
                    if (v == -3) {
                        if (durationBounds.first < v) {
                            durationBounds.first = v;
                        }
                    } else {
                        const map<int, pair<double,double> >::iterator mItr = mask.insert(make_pair(v, NumericAnalysis::masterVariableBounds[v])).first;
        ...
        static vector<bool> variablesOnlyAssignedConstants;
    ...
    public:                
        ...
        */        
        ...
        static void findVariablesOnlyAssignedConstants();
        
        static const vector<bool> & getVariablesOnlyAssignedConstants() {
            return variablesOnlyAssignedConstants;
        }
};
