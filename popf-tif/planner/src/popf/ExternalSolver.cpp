...
int ExternalSolver::count=0;
map<string, double> ExternalSolver::newStatus;
double ExternalSolver::time=0;
bool ExternalSolver::heuristicActive = false;
bool ExternalSolver::timeToCalculate = false;
