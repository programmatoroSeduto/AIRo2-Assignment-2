...
(:init
	(= (cost) 0)
	(at 20.6 (not (bad_view Phenomenon4)))
	(at 38.8 (bad_view Phenomenon4))
	(need_photo Phenomenon4)
	(bad_view Phenomenon4)
	(at 123.0 (not (bad_view Phenomenon4)))
	(at 137.4 (bad_view Phenomenon4))
	(need_photo Phenomenon4)
	(bad_view Phenomenon4)
	(at 37.1 (not (bad_view Star5)))
	(at 45.9 (bad_view Star5))
	(need_photo Star5)
	(bad_view Star5)
	(at 61.0 (not (bad_view Star5)))
	(at 72.3 (bad_view Star5))
	(need_photo Star5)
	(bad_view Star5)
	(at 128.0 (not (bad_view Star5)))
	(at 139.3 (bad_view Star5))
	(need_photo Star5)
	(bad_view Star5)
	(at 3.3 (not (bad_view Phenomenon6)))
	(at 10.6 (bad_view Phenomenon6))
	(need_photo Phenomenon6)
	(bad_view Phenomenon6)
	(at 69.1 (not (bad_view Phenomenon6)))
	(at 75.8 (bad_view Phenomenon6))
	(need_photo Phenomenon6)
	(bad_view Phenomenon6)
	(at 120.0 (not (bad_view Phenomenon6)))
	(at 129.8 (bad_view Phenomenon6))
	(need_photo Phenomenon6)
	(bad_view Phenomenon6)
