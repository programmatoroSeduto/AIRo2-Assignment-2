...
(:init
	(= (cost) 0)
	(at 23.8 (not (bad_view Phenomenon5)))
	(at 38.8 (bad_view Phenomenon5))
	(need_photo Phenomenon5)
	(bad_view Phenomenon5)
	(at 120.3 (not (bad_view Phenomenon5)))
	(at 134.5 (bad_view Phenomenon5))
	(need_photo Phenomenon5)
	(bad_view Phenomenon5)
	(at 30.7 (not (bad_view Star6)))
	(at 42.0 (bad_view Star6))
	(need_photo Star6)
	(bad_view Star6)
	(at 114.7 (not (bad_view Star6)))
	(at 131.4 (bad_view Star6))
	(need_photo Star6)
	(bad_view Star6)
	(at 20.5 (not (bad_view Star7)))
	(at 32.7 (bad_view Star7))
	(need_photo Star7)
	(bad_view Star7)
	(at 87.7 (not (bad_view Star7)))
	(at 106.2 (bad_view Star7))
	(need_photo Star7)
	(bad_view Star7)
	(at 9.0 (not (bad_view Phenomenon8)))
	(at 16.0 (bad_view Phenomenon8))
	(need_photo Phenomenon8)
	(bad_view Phenomenon8)
	(at 53.2 (not (bad_view Phenomenon8)))
	(at 65.6 (bad_view Phenomenon8))
	(need_photo Phenomenon8)
	(bad_view Phenomenon8)
	(at 142.5 (not (bad_view Phenomenon8)))
	(at 151.4 (bad_view Phenomenon8))
	(need_photo Phenomenon8)
	(bad_view Phenomenon8)
	(at 51.5 (not (bad_view Phenomenon9)))
	(at 82.7 (bad_view Phenomenon9))
	(need_photo Phenomenon9)
	(bad_view Phenomenon9)
	(at 15.8 (not (bad_view Star10)))
	(at 34.0 (bad_view Star10))
	(need_photo Star10)
	(bad_view Star10)
	(at 96.3 (not (bad_view Star10)))
	(at 107.7 (bad_view Star10))
	(need_photo Star10)
	(bad_view Star10)
	(at 114.3 (not (bad_view Planet11)))
	(at 152.5 (bad_view Planet11))
	(need_photo Planet11)
	(bad_view Planet11)
	(at 98.5 (not (bad_view Phenomenon12)))
	(at 130.9 (bad_view Phenomenon12))
	(need_photo Phenomenon12)
	(bad_view Phenomenon12)
	(at 9.3 (not (bad_view Phenomenon13)))
	(at 18.6 (bad_view Phenomenon13))
	(need_photo Phenomenon13)
	(bad_view Phenomenon13)
	(at 66.2 (not (bad_view Phenomenon13)))
	(at 77.6 (bad_view Phenomenon13))
	(need_photo Phenomenon13)
	(bad_view Phenomenon13)
	(at 121.8 (not (bad_view Phenomenon13)))
	(at 131.2 (bad_view Phenomenon13))
	(need_photo Phenomenon13)
	(bad_view Phenomenon13)
	(at 43.5 (not (bad_view Phenomenon14)))
	(at 55.8 (bad_view Phenomenon14))
	(need_photo Phenomenon14)
	(bad_view Phenomenon14)
	(at 99.1 (not (bad_view Phenomenon14)))
	(at 117.6 (bad_view Phenomenon14))
	(need_photo Phenomenon14)
	(bad_view Phenomenon14)
	...
	(= (slew_time Star7 Star3)  0.361)
	(= (slew_time Star3 Star7)  0.361)
	...
	(= (slew_time Phenomenon9 Star0)  16.219)
	(= (slew_time Star0 Phenomenon9)  16.219)
	(= (slew_time Phenomenon9 GroundStation1)  34.8)
	(= (slew_time GroundStation1 Phenomenon9)  34.8)
	(= (slew_time Phenomenon9 Star2)  0.977)
	(= (slew_time Star2 Phenomenon9)  0.977)
	...
	(= (slew_time Phenomenon12 Star4)  0.035)
	(= (slew_time Star4 Phenomenon12)  0.035)
	...
	(= (slew_time Phenomenon13 Star2)  32.409)
	(= (slew_time Star2 Phenomenon13)  32.409)
	...
	(= (slew_time Phenomenon14 Star0)  0.54)
	(= (slew_time Star0 Phenomenon14)  0.54)
