...
(:init
	(= (cost) 0)
	(at 26.4 (not (bad_view Star3)))
	(at 32.5 (bad_view Star3))
	(need_photo Star3)
	(bad_view Star3)
	(at 52.4 (not (bad_view Star3)))
	(at 62.4 (bad_view Star3))
	(need_photo Star3)
	(bad_view Star3)
	(at 25.5 (not (bad_view Star4)))
	(at 45.3 (bad_view Star4))
	(need_photo Star4)
	(bad_view Star4)
	(at 12.1 (not (bad_view Phenomenon5)))
	(at 26.8 (bad_view Phenomenon5))
	(need_photo Phenomenon5)
	(bad_view Phenomenon5)
	(at 49.1 (not (bad_view Phenomenon7)))
	(at 69.0 (bad_view Phenomenon7))
	...
	(= (slew_time Phenomenon5 Star1)  4.094)
	(= (slew_time Star1 Phenomenon5)  4.094)
	...
	(= (slew_time Phenomenon5 Star4)  0.529)
	(= (slew_time Star4 Phenomenon5)  0.529)
