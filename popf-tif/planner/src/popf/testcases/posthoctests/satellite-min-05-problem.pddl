...
(:init
	(= (cost) 0)
	(at 0.5 (not (bad_view Star3)))
	(at 25.0 (bad_view Star3))
	(need_photo Star3)
	(bad_view Star3)
	(at 192.8 (not (bad_view Star3)))
	(at 220.6 (bad_view Star3))
	(need_photo Star3)
	(bad_view Star3)
	(at 289.1 (not (bad_view Star3)))
	(at 309.5 (bad_view Star3))
	(need_photo Star3)
	(bad_view Star3)
	(at 70.9 (not (bad_view Phenomenon5)))
	(at 106.9 (bad_view Phenomenon5))
	(need_photo Phenomenon5)
	(bad_view Phenomenon5)
	(at 228.9 (not (bad_view Phenomenon5)))
	(at 268.2 (bad_view Phenomenon5))
	(need_photo Phenomenon5)
	(bad_view Phenomenon5)
	(at 82.5 (not (bad_view Phenomenon6)))
	(at 107.9 (bad_view Phenomenon6))
	(need_photo Phenomenon6)
	(bad_view Phenomenon6)
	(at 230.5 (not (bad_view Phenomenon6)))
	(at 256.3 (bad_view Phenomenon6))
	(need_photo Phenomenon6)
	(bad_view Phenomenon6)
	(at 60.1 (not (bad_view Star7)))
	(at 78.7 (bad_view Star7))
	(need_photo Star7)
	(bad_view Star7)
	(at 198.1 (not (bad_view Star7)))
	(at 221.1 (bad_view Star7))
	(need_photo Star7)
	(bad_view Star7)
	(at 244.5 (not (bad_view Star7)))
	(at 270.4 (bad_view Star7))
	(need_photo Star7)
	(bad_view Star7)
	(at 129.7 (not (bad_view Phenomenon8)))
	(at 183.8 (bad_view Phenomenon8))
	(need_photo Phenomenon8)
	(bad_view Phenomenon8)
	(at 69.5 (not (bad_view Planet9)))
	(at 92.1 (bad_view Planet9))
	(need_photo Planet9)
	(bad_view Planet9)
	(at 258.5 (not (bad_view Planet9)))
	(at 297.4 (bad_view Planet9))
	(need_photo Planet9)
	(bad_view Planet9)
