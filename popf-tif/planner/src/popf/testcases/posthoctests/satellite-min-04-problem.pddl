...
(:init
	(= (cost) 0)
	(at 32.1 (not (bad_view Planet3)))
	(at 44.3 (bad_view Planet3))
	(need_photo Planet3)
	(bad_view Planet3)
	(at 72.7 (not (bad_view Planet3)))
	(at 85.6 (bad_view Planet3))
	(need_photo Planet3)
	(bad_view Planet3)
	(at 138.2 (not (bad_view Planet3)))
	(at 145.5 (bad_view Planet3))
	(need_photo Planet3)
	(bad_view Planet3)
	(at 42.9 (not (bad_view Star4)))
	(at 58.0 (bad_view Star4))
	(need_photo Star4)
	(bad_view Star4)
	(at 142.9 (not (bad_view Star4)))
	(at 162.2 (bad_view Star4))
	(need_photo Star4)
	(bad_view Star4)
	(at 24.3 (not (bad_view Planet5)))
	(at 32.8 (bad_view Planet5))
	(need_photo Planet5)
	(bad_view Planet5)
	(at 97.5 (not (bad_view Planet5)))
	(at 109.8 (bad_view Planet5))
	(need_photo Planet5)
	(bad_view Planet5)
	(at 117.0 (not (bad_view Planet5)))
	(at 124.2 (bad_view Planet5))
	(need_photo Planet5)
	(bad_view Planet5)
	(at 77.9 (not (bad_view Star6)))
	(at 102.9 (bad_view Star6))
	(need_photo Star6)
	(bad_view Star6)
	(at 53.3 (not (bad_view Star7)))
	(at 85.8 (bad_view Star7))
	(need_photo Star7)
	(bad_view Star7)
	(at 40.4 (not (bad_view Phenomenon8)))
	(at 53.8 (bad_view Phenomenon8))
	(need_photo Phenomenon8)
	(bad_view Phenomenon8)
	(at 67.1 (not (bad_view Phenomenon8)))
	(at 79.4 (bad_view Phenomenon8))
	(need_photo Phenomenon8)
	(bad_view Phenomenon8)
	(at 129.5 (not (bad_view Phenomenon8)))
	(at 138.1 (bad_view Phenomenon8))
	(need_photo Phenomenon8)
	(bad_view Phenomenon8)
	(at 14.6 (not (bad_view Phenomenon9)))
	(at 23.2 (bad_view Phenomenon9))
	(need_photo Phenomenon9)
	(bad_view Phenomenon9)
	(at 61.1 (not (bad_view Phenomenon9)))
	(at 70.8 (bad_view Phenomenon9))
	(need_photo Phenomenon9)
	(bad_view Phenomenon9)
	(at 117.2 (not (bad_view Phenomenon9)))
	(at 129.3 (bad_view Phenomenon9))
	(need_photo Phenomenon9)
	(bad_view Phenomenon9)
	...
	(= (slew_time Planet5 Star2)  0.168)
	(= (slew_time Star2 Planet5)  0.168)
	...
	(= (slew_time Phenomenon9 Phenomenon8)  65.519)
	(= (slew_time Phenomenon8 Phenomenon9)  65.519)
)
(:goal (and
