...
(:init
	(= (cost) 0)
	(at 86.9 (not (bad_view Planet5)))
	(at 119.3 (bad_view Planet5))
	(need_photo Planet5)
	(bad_view Planet5)
	(at 92.8 (not (bad_view Phenomenon6)))
	(at 135.6 (bad_view Phenomenon6))
	(need_photo Phenomenon6)
	(bad_view Phenomenon6)
	(at 6.2 (not (bad_view Phenomenon7)))
	(at 17.2 (bad_view Phenomenon7))
	(need_photo Phenomenon7)
	(bad_view Phenomenon7)
	(at 79.3 (not (bad_view Phenomenon7)))
	(at 94.4 (bad_view Phenomenon7))
	(need_photo Phenomenon7)
	(bad_view Phenomenon7)
	(at 153.4 (not (bad_view Phenomenon7)))
	(at 165.1 (bad_view Phenomenon7))
	(need_photo Phenomenon7)
	(bad_view Phenomenon7)
	(at 29.8 (not (bad_view Phenomenon8)))
	(at 39.5 (bad_view Phenomenon8))
	(need_photo Phenomenon8)
	(bad_view Phenomenon8)
	(at 64.5 (not (bad_view Phenomenon8)))
	(at 79.5 (bad_view Phenomenon8))
	(need_photo Phenomenon8)
	(bad_view Phenomenon8)
	(at 160.9 (not (bad_view Phenomenon8)))
	(at 173.3 (bad_view Phenomenon8))
	(need_photo Phenomenon8)
	(bad_view Phenomenon8)
	(at 49.5 (not (bad_view Star9)))
	(at 61.9 (bad_view Star9))
	(need_photo Star9)
	(bad_view Star9)
	(at 68.5 (not (bad_view Star9)))
	(at 80.1 (bad_view Star9))
	(need_photo Star9)
	(bad_view Star9)
	(at 132.0 (not (bad_view Star9)))
	(at 142.6 (bad_view Star9))
	(need_photo Star9)
	(bad_view Star9)
	(at 38.6 (not (bad_view Planet10)))
	(at 53.2 (bad_view Planet10))
	(need_photo Planet10)
	(bad_view Planet10)
	(at 84.5 (not (bad_view Planet10)))
	(at 94.7 (bad_view Planet10))
	(need_photo Planet10)
	(bad_view Planet10)
	(at 160.4 (not (bad_view Planet10)))
	(at 172.0 (bad_view Planet10))
	(need_photo Planet10)
	(bad_view Planet10)
	(at 18.8 (not (bad_view Planet11)))
	(at 37.9 (bad_view Planet11))
	(need_photo Planet11)
	(bad_view Planet11)
	(at 116.7 (not (bad_view Planet11)))
	(at 130.1 (bad_view Planet11))
	(need_photo Planet11)
	(bad_view Planet11)
	(at 107.9 (not (bad_view Phenomenon12)))
	(at 136.2 (bad_view Phenomenon12))
	(need_photo Phenomenon12)
	(bad_view Phenomenon12)
	(at 74.8 (not (bad_view Phenomenon13)))
	(at 111.0 (bad_view Phenomenon13))
	(need_photo Phenomenon13)
	(bad_view Phenomenon13)
	(at 4.6 (not (bad_view Star14)))
	(at 34.4 (bad_view Star14))
	(need_photo Star14)
	(bad_view Star14)
	...
	(= (slew_time Phenomenon8 Phenomenon7)  0.583)
	(= (slew_time Phenomenon7 Phenomenon8)  0.583)
	...
	(= (slew_time Planet10 Phenomenon7)  0.9)
	(= (slew_time Phenomenon7 Planet10)  0.9)
	...
	(= (slew_time Star14 Phenomenon13)  0.268)
	(= (slew_time Phenomenon13 Star14)  0.268)
)
(:goal (and
