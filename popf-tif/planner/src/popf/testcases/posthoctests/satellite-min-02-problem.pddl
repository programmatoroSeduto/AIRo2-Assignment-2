...
(:init
	(= (cost) 0)
	(at 1.1 (not (bad_view Planet3)))
	(at 26.5 (bad_view Planet3))
	(need_photo Planet3)
	(bad_view Planet3)
	(at 171.2 (not (bad_view Planet3)))
	(at 200.9 (bad_view Planet3))
	(need_photo Planet3)
	(bad_view Planet3)
	(at 88.4 (not (bad_view Planet4)))
	(at 109.1 (bad_view Planet4))
	(need_photo Planet4)
	(bad_view Planet4)
	(at 150.0 (not (bad_view Planet4)))
	(at 179.4 (bad_view Planet4))
	(need_photo Planet4)
	(bad_view Planet4)
	(at 75.9 (not (bad_view Phenomenon5)))
	(at 98.8 (bad_view Phenomenon5))
	(need_photo Phenomenon5)
	(bad_view Phenomenon5)
	(at 215.6 (not (bad_view Phenomenon5)))
	(at 239.9 (bad_view Phenomenon5))
	(need_photo Phenomenon5)
	(bad_view Phenomenon5)
	(at 21.4 (not (bad_view Phenomenon6)))
	(at 35.1 (bad_view Phenomenon6))
	(need_photo Phenomenon6)
	(bad_view Phenomenon6)
	(at 87.5 (not (bad_view Phenomenon6)))
	(at 103.9 (bad_view Phenomenon6))
	(need_photo Phenomenon6)
	(bad_view Phenomenon6)
	(at 234.4 (not (bad_view Phenomenon6)))
	(at 255.5 (bad_view Phenomenon6))
	(need_photo Phenomenon6)
	(bad_view Phenomenon6)
	(at 162.8 (not (bad_view Star7)))
	(at 201.2 (bad_view Star7))
	(need_photo Star7)
	(bad_view Star7)
