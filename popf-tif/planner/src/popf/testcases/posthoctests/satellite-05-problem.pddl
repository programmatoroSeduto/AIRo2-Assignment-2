...
(:init
	(= (reward) 0)
	(at 0.5 (clear_image Star3))
	(at 25.0 (not (clear_image Star3)))
	(need_photo Star3)
	(at 192.8 (clear_image Star3))
	(at 220.6 (not (clear_image Star3)))
	(need_photo Star3)
	(at 289.1 (clear_image Star3))
	(at 309.5 (not (clear_image Star3)))
	(need_photo Star3)
	(at 70.9 (clear_image Phenomenon5))
	(at 106.9 (not (clear_image Phenomenon5)))
	(need_photo Phenomenon5)
	(at 228.9 (clear_image Phenomenon5))
	(at 268.2 (not (clear_image Phenomenon5)))
	(need_photo Phenomenon5)
	(at 82.5 (clear_image Phenomenon6))
	(at 107.9 (not (clear_image Phenomenon6)))
	(need_photo Phenomenon6)
	(at 230.5 (clear_image Phenomenon6))
	(at 256.3 (not (clear_image Phenomenon6)))
	(need_photo Phenomenon6)
	(at 60.1 (clear_image Star7))
	(at 78.7 (not (clear_image Star7)))
	(need_photo Star7)
	(at 198.1 (clear_image Star7))
	(at 221.1 (not (clear_image Star7)))
	(need_photo Star7)
	(at 244.5 (clear_image Star7))
	(at 270.4 (not (clear_image Star7)))
	(need_photo Star7)
	(at 129.7 (clear_image Phenomenon8))
	(at 183.8 (not (clear_image Phenomenon8)))
	(need_photo Phenomenon8)
	(at 69.5 (clear_image Planet9))
	(at 92.1 (not (clear_image Planet9)))
	(need_photo Planet9)
	(at 258.5 (clear_image Planet9))
	(at 297.4 (not (clear_image Planet9)))
	(need_photo Planet9)
	...
	(= (slew_time Star7 Star4)  64.459)
	(= (slew_time Star4 Star7)  64.459)
