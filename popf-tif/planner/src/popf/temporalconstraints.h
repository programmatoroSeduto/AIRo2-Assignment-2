...
struct FluentInteraction {
    ...
    /** @brief A record of which fluents are involved in an active constraints with this variable. The key denote the other fluent, the value is a map of end and start of the invariant */
    map<int, map<int,int> > fluentsRelated; 
